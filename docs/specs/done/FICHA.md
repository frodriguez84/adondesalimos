...
**Estado:** ✅ Implementado (2026-07-20) — F1 (ficha propia), F2 (Google en vivo) y F3 (foto y atribución) cerradas. QA en vivo por Playwright (FICHA-10/11). Ver [`SPECS_ARCHIVO.md`](../../archive/SPECS_ARCHIVO.md#ficha)
