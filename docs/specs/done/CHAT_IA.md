...
**Estado:** ✅ Implementado (2026-07-26) — 3 fases cerradas (F1 motor/cupo/endpoint · F2 UI `/chat` · F3 modo shortlist en VOTACION). QA APROBADO, ver `docs/qa/AnalisisQA.md` § *QA /qa-spec — CHAT_IA (spec completo, 3 fases)* (+ QA de fase F1/F2/F3)
