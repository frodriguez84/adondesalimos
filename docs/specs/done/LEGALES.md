...
**Estado:** ✅ Implementado (2026-08-21) — las 4 fases, QA **APROBADO** (21/21)
...
> que la omisión no sea un silencio, **el documento ofrece el nombre a pedido** por el mismo canal
> de los derechos: *«si querés saber exactamente quiénes son, escribinos»*. Un nombre disponible a
> pedido no es lo mismo que un nombre callado.
>
> ⚠️ **Si alguna vez se agrega un tercero que reciba contenido del usuario** (no infraestructura:
> otro modelo de IA, otro procesador de pagos, un analytics), **va nombrado**. La línea de esta
> enmienda es *proveedor de infraestructura invisible* vs *destinatario de tus datos*, no
> «cuántos nombres ponemos».
...
### F0 — Separar la atribución (código, sin texto nuevo) ✅ 2026-08-21
...
### F1 — Términos y Condiciones (`/legales/terminos`) ✅ 2026-08-21
...
### F2 — Política de privacidad (`/legales/privacidad`) ✅ 2026-08-21
...
### F3 — Baja y arrepentimiento (`/legales/baja` + link en el footer) ✅ 2026-08-21
