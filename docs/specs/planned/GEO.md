...
| GEO-12 | Preguntarle a ChatGPT, Claude, Perplexity y Gemini «cómo decidimos entre varios a dónde salir en Buenos Aires» | **Línea de base anotada antes de F1** y repetida a los 60 días. No es un PASS/FAIL: es el número que dice si esto sirvió |
