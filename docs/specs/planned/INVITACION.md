...
**Estado:** ✅ Implementado (2026-08-14) — los 8 de R2 + `PBETA-R4-02`. Queda el `git mv` a `done/` (paso 5 del cierre, lo hace `/close-spec`)
...
**Enmienda parcialmente la decisión 13 de [`VOTACION`](done/VOTACION.md)** (resultados en vivo
