...
- [ ] Lugares sin zona: reporte generado y revisado (se espera minoría en los bordes del
      bbox — Escobar/Pilar/Varela profundos)
...
| ZON-05 | Sanity de densidad | Las 4 zonas de Palermo suman más lugares publicados que la región Sur entera (el dato que justificó la granularidad asimétrica) |
| ZON-06 | Sin zona | Los lugares con 0 zonas son minoría y están en los bordes del bbox, no en el centro de CABA |
