...
**Estado:** 🟡 Parcial — F1 (motor, cupo, endpoint) ✅ y F2 (UI `/chat`) ✅ Implementadas (2026-07-25); F3 (modo shortlist en VOTACION) pendiente. QA: `docs/qa/AnalisisQA.md` § CHAT_IA F1 y § CHAT_IA F2
